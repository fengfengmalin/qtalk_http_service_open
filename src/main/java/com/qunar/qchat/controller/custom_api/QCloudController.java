package com.qunar.qchat.controller.custom_api;
...
public class QCloudController {
    ...
    public JsonResult<?> syncCloudMainList(@RequestBody String json) {
        ...
        try {
            ...
            e.printStackTrace();
            stackTrace = ExceptionUtils.getStackTrace(e);
            LOGGER.debug("update main cloud error ", e , json);
        }
        return JsonResultUtils.fail(0, "服务器操作异常:\n "+stackTrace);
    }
    ...
    public JsonResult<?> saveToSub(@RequestBody String json) {
        ...
        try {
            ...
            e.printStackTrace();
            stackTrace = ExceptionUtils.getStackTrace(e);
            LOGGER.debug("save sub cloud error ", e , json);
        }
        return JsonResultUtils.fail(0, "服务器操作异常:\n "+stackTrace);
    }
    ...
    public JsonResult<?> updateSub(@RequestBody String json) {
        ...
        try {
            ...
            e.printStackTrace();
            stackTrace = ExceptionUtils.getStackTrace(e);
            LOGGER.debug("update sub cloud error ", e , json);
        }
        return JsonResultUtils.fail(0, "服务器操作异常:\n "+stackTrace);
    }
    ...
    public JsonResult<?> getCloudSub(@RequestBody String json) {
        ...
        try {
            ...
            e.printStackTrace();
            stackTrace = ExceptionUtils.getStackTrace(e);
            LOGGER.debug("get sub cloud error ", e , json);
        }
        return JsonResultUtils.fail(0, "服务器操作异常:\n "+stackTrace);
    }
    ...
    public JsonResult<?> getCloudMainHistory(@RequestBody String json) {
        ...
        try {
            ...
            e.printStackTrace();
            stackTrace = ExceptionUtils.getStackTrace(e);
            LOGGER.debug("save main cloud history error ", e , json);
        }
        return JsonResultUtils.fail(0, "服务器操作异常:\n "+stackTrace);
    }
    ...
    public JsonResult<?> getCloudSubHistory(@RequestBody String json) {
        ...
        try {
            ...
            e.printStackTrace();
            stackTrace = ExceptionUtils.getStackTrace(e);
            LOGGER.debug("save sub history cloud error ", e , json);
        }
        return JsonResultUtils.fail(0, "服务器操作异常:\n "+stackTrace);
    }
